    ...
    if (e.keyCode == 9) { // tab
      ...
      switch (cmd) {
        ...
        case 'certifications':
          ...
          break;
        case 'projects':
          var result = "<h3>Projects </h3><p><b>MorphBot :</b> Implemented an LSTM model for rap lyrics generation in Arabic Moroccan dialect using : Scrapy to scrap the songs lyrics & Keras for the deep learning network. <br> <b> GTE-Gesture To English :</b> Trained a Vgg19 neural network to recognize sign language gestures and return the equivalent english letters using OpenCV & Keras. <br> <b>CoviZZ :</b> Built a web application for visualizing Covid19 cases in Morocco by region & city, using : SparkJava, PL/SQL, Javascript, OracleDB 18cXE. <br> <b>Minoch :</b> Text editor for Unix-like computing systems developed in C language. </p>";
          output(result);
          break;
        case 'interests': 
